...
const FEATURES = [
  {
    icon: "📸",
    label: "feature-icon-green",
    accent: "feature-accent-green",
  ...
  {
    icon: "🐦",
    label: "feature-icon-gold",
    accent: "feature-accent-gold",
    title: "Meme Taglines",
        ...
        <div className="ticker-inner">
          {items.map((t, i) => (
            <div className="ticker-item" key={i}>
              ...
              <span
                className={`ticker-rating ${t.delta > 0 ? "up" : t.delta < 0 ? "down" : ""}`}
              >
                {t.rating.toFixed(1)}{" "}
                {t.delta > 0
                  ? `▲+${t.delta}`
...
export const LandingPage: React.FC<Props> = ({
  ...
  const showcaseCards = demoCards
    .filter((c) => c.rarity === "gold")
    .slice(0, 4);
    ...
    <div style={{ minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <nav className="land-nav">
        ...
        <div className="land-nav-links">
          ...
          <button className="land-nav-link" onClick={() => scrollTo("cards")}>
            The Cards
          </button>
          <button className="land-nav-link" onClick={() => scrollTo("play")}>
            Play
          </button>
        </div>
        <button className="land-nav-cta" onClick={onEnterApp}>
          Enter App →
        </button>
      </nav>
      ...
      <section className="land-hero">
        ...
        <div className="land-hero-left">
          ...
          <p className="land-hero-sub">
            Real match photos. <strong>Credible stats.</strong> Ratings that
            move after every game. A meme tagline scraped off Twitter.{" "}
            <strong>All live, every matchday.</strong>
          </p>
          ...
          <div className="hero-anakin-credit">
            ...
            — real match ratings &amp; memes, scraped fresh every matchday
          </div>
        </div>
      ...
      >
        ...
        <p className="sub">
          FIFA cards are frozen all season. Ours update every real match —
          photo, rating, caption.
        </p>
        <div className="features-grid">
          {FEATURES.map((f) => (
            <div
              key={f.title}
              className={`feature-card glass ${f.accent}`}
        ...
        <div className="land-section" style={{ textAlign: "center" }}>
          ...
          <div className="steps-row">
            <div className="step">
              ...
              <p>
                5 living cards scraped fresh. Worst card first, god-tier lands
                last. Watch the meme tagline load in real time.
              </p>
            </div>
            <div className="step">
              ...
              <p>
                Pick a card, pick a stat. ATK beats MID beats DEF beats ATK —
                the counter gives you ×1.2. A 78 can beat an 88.
              </p>
            </div>
            <div className="step">
              ...
              <p>
                Best of 3. Winner takes the opponent's wagered card. Real
                stakes, provable wins, and a screenshot-able meme to close it
                out.
              </p>
            </div>
          </div>
      ...
      <section className="land-section" style={{ textAlign: "center" }}>
        ...
        >
          ...
          <div
            style={{
              background: "rgba(43,245,154,0.08)",
              padding: "14px 16px",
              textAlign: "center",
          ...
          {[
            [
              "Ratings hardcoded once a year",
              "→",
              "Re-rated after every real match",
            ],
            [
              "Static portrait photo",
              "→",
              "Real action photo from latest match",
            ],
            ["No personality", "→", "Live meme tagline from football Twitter"],
            [
              '"Higher rating always wins"',
              "→",
              "Positional counter triangle = real reads",
            ],
            ...
            <>
              ...
              <div
                ...
                style={{
                  background:
                    i % 2 === 0
                      ? "rgba(43,245,154,0.04)"
                      : "rgba(43,245,154,0.02)",
                  padding: "14px 0",
                  textAlign: "center",
                  color: "var(--live)",
                  fontSize: 16,
      ...
      <section className="land-cta-section" id="play">
        ...
        <p>
          Join a room, open a pack, and play with cards that moved last night.
        </p>
